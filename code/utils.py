...
def random_prompt(concept, classes):
    ...
    for k in range(1, n+1):
        if (k-1)/n < p < k/n:
            ...
            prompt = f"This is a sentence that expresses a {classes[k-1]} feeling:"
...
def get_sentiment_labels(file_path, args):
    '''
        ...
        It has been checked that the predictions given here are correctly processed in the fine-tuning afterwards
    '''
    batch_sentiments = []
    ml = args['max_length']
